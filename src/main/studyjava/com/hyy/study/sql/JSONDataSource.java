...
public class JSONDataSource {
	...
	public static void main(String[] args) {
		...
		DataFrame studentScoresDF = sqlContext.read().json("textdata/students.json");
		...
		goodStudentDF.write().format("json").mode(SaveMode.Overwrite).save("textdata/goodStudentJson");
	}
}
